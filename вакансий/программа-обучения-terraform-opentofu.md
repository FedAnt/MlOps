...
**Статус:** 🔄 T0 в работе (провайдеры: Yandex network mirror; цель apply — k3s lab)

---

## Журнал

### Урок T0 (в работе, 2026-08-12)

Сделано: старт теории — TF vs Ansible, state, plan/apply/destroy; контур lab = k3s + Yandex mirror.  
Артефакт: —  
Критерий: устно 2 мин на интервью.
---
